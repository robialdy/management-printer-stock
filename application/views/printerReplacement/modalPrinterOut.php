			...
			<div class="modal-body">
				...
				<div class="row">
					...
					<div class="col mt-2">
						...
						<div class="row mb-1">
							<div class="form-check col">
								<input type="radio" name="snlama" id="diketahui" value="DIKETAHUI" required>
								<label class="form-check-label" for="diketahui">
									DIKETAHUI
								</label>
							</div>
							<div class="form-check col">
								<input type="radio" name="snlama" id="tidak" value="TIDAK">
